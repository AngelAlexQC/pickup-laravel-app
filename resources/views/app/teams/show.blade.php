                ...
                <div class="mt-4 px-4">
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.teams.inputs.owner_id')
                        </h5>
                        <span>{{ optional($team->owner)->name ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                    ...
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.teams.inputs.slug')
                        </h5>
                        <span>{{ $team->slug ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.teams.inputs.address')
                        </h5>
                        <span>{{ $team->address ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.teams.inputs.phone')
                        </h5>
                        <span>{{ $team->phone ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.teams.inputs.meta')
                        </h5>
                        <span>{{ $team->meta ?? '-' }}</span>
                    </div>
                </div>
